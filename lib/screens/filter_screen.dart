...
class _FilterScreenState extends State<FilterScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                ...
                children: [
                  ...categories
                      .map((category) => buildSingleCheckbox(category))
                      .toList()
                ],
              )),
              Padding(
                ...
                child: Center(
                  ...
                  style: ElevatedButton.styleFrom(primary: mobileThemeColor),
                  onPressed: () {
  ...
  Widget buildSingleCheckbox(CategoryOption category) => buildCheckbox(
      category: category,
      onClicked: () {
        setState(() {
  ...
  Widget buildCheckbox(
      ...
      ListTile(
          ...
          leading: Checkbox(
              value: category.value, onChanged: (value) => onClicked()));
}
